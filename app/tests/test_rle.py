...
def test_get_pairs():
    pairs = group_consecutive_elements(listify_string(string))
...
def test_compare_pairs():
    comparisons = compare_tuples(group_consecutive_elements(listify_string(string)))
...
def test_get_break_points():
    break_points = get_break_points(
        compare_tuples(group_consecutive_elements(listify_string(string)))
    )
...
def test_break_list():
    ...
    assert broken_list == [["A", "A"], ["B", "B"], ["C"], ["D", "D", "D"], ["E"]]
